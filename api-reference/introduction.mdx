...
<Tip>
  Chame `setExternalUserContext` o mais cedo possível após o login do usuário. Isso vincula o perfil anônimo (criado pelo tracker) ao ID real, unificando todo o histórico de navegação.
</Tip>
